...
const DashboardForAdmin = () => {
  ...
  const StatCard = ({ title, value, icon: Icon, gradient, secondaryValue }) => (
  ...
  return (
    <div className="p-6">
      <div className="mb-8 bg-white/50 p-6 rounded-2xl backdrop-blur-sm border border-gray-200/50">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Dashboard Overview</h1>
        <p className="text-gray-600 text-lg">Monitor your key metrics and performance indicators</p>
      </div>
      ...
      <Card className="mb-6 border border-gray-200/80 shadow-lg">
